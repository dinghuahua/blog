...
## 本地创建分支并推送到远端
    ...
    如果没有关联，git会在下面的操作中提示显示的添加关联,关联的目的是
        ...
        关联关系问题到解决 ![alt 关联关系](https://github.com/dinghuahua/blog/blob/master/images/git1.png "关联关系问题到解决")
        config文件前后对比 ![alt config文件](https://github.com/dinghuahua/blog/blob/master/images/git2.png "config文件前后对比")